...
import com.brave.utils.JedisCache;
import com.brave.utils.SerializableUtil;
...
public class KyxmApi {
	...
	@RequestMapping(value = "/api/kyxm/others/{username}", method = RequestMethod.GET, produces = "application/json; charset=UTF-8")
	public List<ShowKyxms> getMyKyxm(@PathVariable("username") String username) {// 通过其他渠道用户名进行查询课题
